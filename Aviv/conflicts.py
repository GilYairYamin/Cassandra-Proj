...
def extract_queries_and_timestamps(data, timestamp_line):
    ...
    for query, _ in queries_and_times:
        ...
        trace_timestamps = [
            trace[timestamp_line] for trace in data["traces"] if trace["query"] == query
        ]
        if trace_timestamps:
...
def run_conflicts(input_filename, timestamp_line):
...
if __name__ == "__main__":
    ...
    run_conflicts(input_filename, timestamp_line)
